...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/kgemio/kaspad)
...
```bash
$ git clone https://github.com/kgemio/kaspad
$ cd kaspad
$ go install . ./cmd/...
```
...
The [integrated github issue tracker](https://github.com/kgemio/kaspad/issues)
